...
const lowerNavItems: LowerNavItemType[] = [
  {
    ...
    subLinks: [
      {
        title: "manage orders",
        description: "manage orders with convenience",
        navigateTo: `${rootSegment}/orders`,
      },
    ],
  },
  {
    ...
    subLinks: [
      {
        ...
        navigateTo: `${rootSegment}/feedbacks`,
      },
    ],
  },
  {
    ...
    subLinks: [
      {
        ...
        navigateTo: `${rootSegment}/products`,
      },
    ],
  },
  {
    ...
    subLinks: [
      {
        ...
        navigateTo: `${rootSegment}/profile`,
      },
    ],
  },
];
